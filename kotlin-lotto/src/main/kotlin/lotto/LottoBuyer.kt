...
class LottoBuyer {
    ...
    companion object {
        private const val PURCHASE_AMOUNT_ERROR = "$ERROR_PREFIX 로또 구입 가격은 1,000원으로 나누어 떨어져야 합니다."
        private const val WINNING_AMOUNT_ERROR = "$ERROR_PREFIX 당첨번호는 중복되지 않는 6개의 숫자(1~45 사이)여야 합니다."
        private const val BONUS_AMOUNT_ERROR = "$ERROR_PREFIX 보너스 번호는 1~45 사이의 숫자이며 당첨번호와 중복되면 안됩니다."
    }
}
